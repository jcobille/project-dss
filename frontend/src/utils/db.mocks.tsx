...
export const actorsListMock: Actor[] = [
  {
...
export const selectedActorMock: Actor = {
  id: "6369cf9f6b314926684a432e",
  firstName: "Dwayne",
  lastName: "Johnson",
  gender: "Male",
...
export const editedActorMock: Actor = {
  id: "6369cf9f6b314926684a432e",
  firstName: "Dwayness",
  lastName: "Johnson",
  gender: "Male",
...
export const newActorMockData = {
  id: "63722028fcd7e53828b65d22",
  firstName: "test",
  lastName: "test",
  gender: "Male",
  age: "60",
...
export const newMovieMockData = {
  id: "6355028fcd7e12428b65d22",
  title: "Title",
...
export const editedMovieMockData = {
  id: "635d3d39425fc647181495f2",
  title: "Black Adam -edited",
  description:
    "Nearly 5,000 years after he was bestowed with the almighty powers of the Egyptian gods—and imprisoned just as quickly—Black Adam is freed from his earthly tomb, ready to unleash his unique form of justice on the modern world.",
  releasedDate: "2022-10-19",
  duration: "126",
...
export const actorMoviesMock: Movie[] = [
  {
    id: "635d3d39425fc647181495f2",
    title: "Black Adam",
    description:
